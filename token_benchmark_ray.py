            ...
            for out in outs:
                ...
                with completed_requests_lock:
                    if num_completed_requests < max_num_completed_requests:
                        if num_output_tokens and request_metrics[common_metrics.NUM_OUTPUT_TOKENS]:
                        ...
                        request_metrics[common_metrics.REQ_OUTPUT_THROUGHPUT] = num_output_tokens / request_metrics[common_metrics.E2E_LAT] if request_metrics[common_metrics.E2E_LAT] else 0
